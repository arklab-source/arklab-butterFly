...
#define MSP_BAT               120   //out message         get battery value
...
#define MSP_SET_MOTOR            214   //in message          set individual motor value
#define MSP_SET_FLYMODE          215   //in message          set fly mode on/off
